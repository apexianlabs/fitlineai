...
const COLOR = '#dc2626'
const PRODUCT_NAME = 'FitLine AI'
const PRODUCT_INITIAL = 'F'
const COOKIE = 'fit'
const ITEM_NAME = 'Fits'
...
const Logo = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="50" cy="50" r="42" fill="url(#fl1)"/>
    ...
    <path d="M64 46 L70 46 L70 54" stroke="white" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" fill="none" opacity="0.9"/>
  </svg>
)
  ...
  const Sidebar = () => (
    <div style={{width:220,background:'linear-gradient(180deg,#0a0f2e 0%,#0f172a 100%)',display:'flex',flexDirection:'column',padding:'20px 12px',height:'100vh',position:'sticky',top:0,flexShrink:0,overflowX:'hidden'}}>
      ...
      <div style={{marginTop:'auto',borderTop:'1px solid rgba(255,255,255,0.06)',paddingTop:14}}>
        ...
        <button onClick={() => { document.cookie='fit_token=;max-age=0'; document.cookie='fit_user=;max-age=0'; router.push('/login') }}
