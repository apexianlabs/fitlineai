...
export async function POST(request) {
  try {
    ...
    const prompt = `You are an AI assistant for FitLine AI. Generate a concise daily briefing in 2 sentences based on: ${JSON.stringify(body)}. Be specific and actionable.`
    ...
    return NextResponse.json({ briefing: 'Your FitLine AI dashboard is ready.' })
  }
}
