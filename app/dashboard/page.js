...
export default function DashboardPage() {
  ...
  const handleLogout = () => {
    document.cookie = 'fit_token=; path=/; max-age=0'
    document.cookie = 'fit_user=; path=/; max-age=0'
    router.push('/login')
  }
    ...
    <div style={{width:220,background:'#0f172a',display:'flex',flexDirection:'column',minHeight:'100vh',flexShrink:0,position:'relative'}}>
      ...
      <div style={{padding:'20px 16px 16px',borderBottom:'1px solid rgba(255,255,255,0.06)'}}>
        <Link href="/" style={{display:'flex',alignItems:'center',gap:9,textDecoration:'none'}}>
          <div style={{width:28,height:28,borderRadius:7,background:'#dc2626',display:'flex',alignItems:'center',justifyContent:'center',fontSize:13,fontWeight:800,color:'#fff',flexShrink:0}}>F</div>
          <div>
            <p style={{fontSize:13,fontWeight:800,color:'#fff',lineHeight:1,letterSpacing:'-0.3px'}}>FitLine AI</p>
            <p style={{fontSize:10,color:'#475569',lineHeight:1,marginTop:2}}>Your perfect position</p>
          </div>
        </Link>
      </div>
  ...
  return (
    <div style={{display:'flex',minHeight:'100vh',fontFamily:'Inter,system-ui,sans-serif',background:'#f8fafc'}}>
      ...
      <div style={{flex:1,display:'flex',flexDirection:'column',minWidth:0,overflow:'hidden'}}>
        ...
        <div style={{background:'#fff',borderBottom:'1px solid #f1f5f9',height:56,display:'flex',alignItems:'center',padding:'0 20px',gap:12,flexShrink:0}}>
          ...
          <div style={{flex:1}}>
            ...
            <p style={{fontSize:11,color:'#94a3b8',marginTop:1}}>Here's your FitLine AI overview.</p>
          </div>
          <Link href="/generate"
          ...
          <div style={{display:'grid',gridTemplateColumns: isMobile ? '1fr' : '1fr 300px',gap:16}}>
            ...
            <div style={{display:'flex',flexDirection:'column',gap:12}}>
              ...
              <div style={{background:'linear-gradient(135deg,#dc2626 0%,#dc2626cc 100%)',borderRadius:14,padding:20,color:'#fff'}}>
                ...
                <p style={{fontSize:12,color:'rgba(255,255,255,0.75)',marginBottom:14,lineHeight:1.5}}>AI bike fitting — get your perfect position in minutes</p>
      ...
      <div style={{borderTop:'1px solid #e2e8f0',padding:'14px 28px',display:'flex',alignItems:'center',justifyContent:'space-between',background:'#fff',marginTop:'auto'}}>
        <span style={{fontSize:11,color:'#94a3b8'}}>© 2026 FitLine AI</span>
        <div style={{display:'flex',gap:20}}>
          <a href="https://fitlineai.app/privacy" style={{fontSize:11,color:'#94a3b8',textDecoration:'none'}} target="_blank" rel="noreferrer">Privacy</a>
          <a href="https://fitlineai.app/terms" style={{fontSize:11,color:'#94a3b8',textDecoration:'none'}} target="_blank" rel="noreferrer">Terms</a>
          <a href="https://fitlineai.app/support" style={{fontSize:11,color:'#94a3b8',textDecoration:'none'}} target="_blank" rel="noreferrer">Support</a>
        </div>
      </div>
    </div>
  )
